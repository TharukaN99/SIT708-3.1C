...
public class QuizQuestions extends AppCompatActivity {
    ...
    private void submitAnswer() {
        ...
        if (option1Button.getText().toString().equals(correctAnswer)) {
            option1Button.setBackgroundColor(getResources().getColor(R.color.correctAnswer));
        } else if (option1Button.getText().toString().equals(selectedAnswer)) {
            option1Button.setBackgroundColor(getResources().getColor(R.color.wrongAnswer));
        }

        if (option2Button.getText().toString().equals(correctAnswer)) {
            option2Button.setBackgroundColor(getResources().getColor(R.color.correctAnswer));
        } else if (option2Button.getText().toString().equals(selectedAnswer)) {
            option2Button.setBackgroundColor(getResources().getColor(R.color.wrongAnswer));
        }

        if (option3Button.getText().toString().equals(correctAnswer)) {
            option3Button.setBackgroundColor(getResources().getColor(R.color.correctAnswer));
        } else if (option3Button.getText().toString().equals(selectedAnswer)) {
            option3Button.setBackgroundColor(getResources().getColor(R.color.wrongAnswer));
        }

        if (option4Button.getText().toString().equals(correctAnswer)) {
            option4Button.setBackgroundColor(getResources().getColor(R.color.correctAnswer));
        } else if (option4Button.getText().toString().equals(selectedAnswer)) {
            option4Button.setBackgroundColor(getResources().getColor(R.color.wrongAnswer));
        }
